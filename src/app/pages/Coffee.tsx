...
const DRINKS: Drink[] = [
  ...
  { id:"infused-frappuccino", name:"Infused Frappuccino", type:"Oil", profile:"Sweet / Frozen", build:"Blended coffee + cannabis oil + ice + milk", tags:["cold","sweet","oil"], emoji:"🥤", strength:1, sweetness:3, servings:"1 cup", ingredients:["180ml cold brew","1 tbsp coconut oil","120ml milk","2 tbsp sugar","1 cup ice","Whipped cream"], steps:["Add all ingredients to a blender.","Blend on high until smooth and icy.","Pour and top with whipped cream."], note:"Oil blends completely smooth — no separation in a Frappuccino." },
  { id:"golden-latte", name:"Golden THC Latte", type:"Oil", profile:"Earthy / Warming", build:"Cannabis oil + turmeric + honey + oat milk", tags:["wellness","oil","dairy-free"], emoji:"✨", strength:1, sweetness:1, servings:"1 cup", ingredients:["240ml oat milk","1 tbsp coconut oil","1 tsp turmeric","½ tsp cinnamon","¼ tsp ginger","1 tbsp honey"], steps:["Heat oat milk — don't boil.","Whisk in cannabis oil, turmeric, cinnamon, ginger.","Pour into mug, stir in honey."], note:"No caffeine — perfect for an evening microdose." },
  { id:"infused-matcha", name:"Infused Matcha Latte", type:"Oil", profile:"Earthy / Sweet", build:"Matcha + cannabis oil + steamed oat milk", tags:["wellness","oil","dairy-free"], emoji:"🍵", strength:1, sweetness:1, servings:"1 cup", ingredients:["2 tsp matcha powder","60ml hot water (175°F)","1 tbsp coconut oil","200ml steamed oat milk","1 tbsp honey"], steps:["Whisk matcha into hot water until smooth.","Add cannabis oil and whisk in.","Pour steamed milk over matcha.","Sweeten with honey."], note:"Use 175°F water — boiling makes matcha bitter." },
  { id:"infused-chai", name:"Infused Chai Latte", type:"Oil", profile:"Spiced / Warming", build:"Chai concentrate + cannabis oil + steamed milk", tags:["sweet","wellness","oil"], emoji:"🌶️", strength:1, sweetness:2, servings:"1 cup", ingredients:["120ml chai concentrate","1 tbsp coconut oil","180ml steamed oat milk","1 tsp honey"], steps:["Heat chai concentrate.","Stir in coconut oil.","Top with steamed oat milk and honey."], note:"Chai spices may slow THC absorption slightly." },
  { id:"infused-hot-chocolate", name:"Infused Hot Chocolate", type:"Oil", profile:"Rich / Indulgent", build:"Hot milk + cocoa + coconut oil", tags:["sweet","chocolate","oil"], emoji:"🍫", strength:1, sweetness:3, servings:"1 cup", ingredients:["240ml whole milk","2 tbsp cocoa powder","2 tbsp sugar","1 tbsp coconut oil","Whipped cream"], steps:["Heat milk in a saucepan.","Whisk in cocoa, sugar, and cannabis oil.","Pour into mug, top with whipped cream."], note:"Higher fat milk = better THC absorption." },
  ...
  { id:"coconut-coffee", name:"Infused Coconut Coffee", type:"Oil", profile:"Tropical / Rich", build:"Coffee + coconut oil + coconut milk", tags:["keto","oil","dairy-free"], emoji:"🥥", strength:2, sweetness:1, servings:"1 cup", ingredients:["240ml hot coffee","1 tbsp coconut oil","60ml coconut milk","1 tsp honey"], steps:["Add cannabis oil and coconut milk to blender.","Add hot coffee and blend 20 seconds.","Pour and sweeten with honey."], note:"Coconut oil + coconut milk = maximum fat for THC absorption." },
