...
export const RECIPES: SpreadDipRecipe[] = [
  {
    ...
    build: "Coconut oil folded into peanut butter",
    tags: ["nut-butter", "spread", "classic"],
    emoji: "🥜",
    heat: 0,
    sweetness: 1,
    servings: "16 servings (about 1 tbsp each)",
    ingredients: ["Peanut butter", "Coconut oil", "Salt", "Honey (optional)"],
    steps: [
      "Soften peanut butter slightly so it mixes easily (room temp or gentle warm).",
      "Fold in coconut oil until completely smooth — no streaks.",
  ...
  },
  {
    ...
    build: "Coconut oil folded into almond butter",
    tags: ["nut-butter", "spread", "creamy"],
    emoji: "🌰",
    heat: 0,
    sweetness: 0,
    servings: "16 servings (about 1 tbsp each)",
    ingredients: ["Almond butter", "Coconut oil", "Salt", "Cinnamon (optional)"],
    steps: [
      "Stir almond butter well if oil has separated.",
      "Fold in coconut oil until uniform.",
