...
const recipeCategories = [
  ...
  { id: "popcorn", name: "🍿 Popcorn", emoji: "🍿", description: "Savory, sweet & spicy popcorn" },
...
const standardRecipes: Record<string, any[]> = {
  ...
  "savory-meals": [    {
    ...
    },
    {
      ...
      name: "Garlic Butter Fries",
      servings: 2,
      ingredients: ["Potato Fries", "Cannabutter", "Garlic Powder", "Salt", "Black Pepper", "Fresh Parsley"],
      amounts: [500, 28, 3, 3, 2, 5],
      units: ["g", "g", "g", "g", "g", "g"],
      instructions: [
        "Cook fries your way — oven (425°F/20 min), air fryer (400°F/15 min), or deep fry. We're here for the sauce.",
        "While fries cook, melt cannabutter in a small saucepan over low heat.",
        "Stir garlic powder into the melted butter.",
        "Transfer hot fries to a large bowl.",
        "Drizzle garlic cannabutter over fries while tossing continuously.",
        "Season with salt and pepper, top with fresh parsley.",
        "Serve immediately — fries absorb butter best while hot.",
      ],
    },
    {
    ...
    },
    {
      ...
      name: "Garlic Butter Fries",
      servings: 2,
      ingredients: ["Popcorn Kernels", "Cannabutter", "Garlic Powder", "Salt", "Black Pepper"],
      amounts: [500, 28, 3, 3, 1],
      units: ["g", "g", "g", "g", "g"],
      instructions: [
        "Cook fries your way — oven (425°F/25 min), air fryer (400°F/15 min), or deep fry.",
        "While fries cook, melt cannabutter in a small pan over low heat.",
        "Stir garlic powder into melted cannabutter.",
        "Toss hot fries in garlic butter immediately.",
    ...
    },
    {
      ...
      servings: 2,
      ingredients: ["Popcorn Kernels", "Cannabis Coconut Oil", "Cajun Seasoning", "Garlic Powder", "Salt"],
      amounts: [500, 28, 5, 2, 2],
      units: ["g", "ml", "g", "g", "g"],
      instructions: [
        "Cook fries your way until very crispy.",
        "Toss hot fries in cannabis coconut oil.",
        "Immediately shake on Cajun seasoning and garlic powder.",
        "Toss vigorously — seasoning settles fast.",
    ...
    },
    {
      ...
      servings: 2,
      ingredients: ["Popcorn Kernels", "Cannabis Olive Oil", "Parmesan Cheese", "Salt", "Black Pepper"],
      amounts: [500, 20, 30, 2, 1],
      units: ["g", "ml", "g", "g", "g"],
      instructions: [
        "Cook fries until golden and crispy.",
        "Drizzle cannabis olive oil over hot fries and toss.",
  ...
  "popcorn": [
    {
      ...
      units: ["g", "g", "g", "g"],
      instructions: [
        "Pop popcorn kernels using your preferred method — stovetop, air popper, or microwave.",
        "Transfer popped corn to a large bowl.",
        "Melt cannabutter in a small saucepan over low heat.",
        "Stir garlic powder into the melted butter.",
        "Drizzle butter over popcorn while tossing continuously.",
        "Season with salt and toss until every kernel is coated.",
        "Serve immediately — popcorn absorbs sauce best while hot.",
      ],
    },
    {
      id: "caramel-popcorn",
      ...
      instructions: [
        "Pop popcorn and spread on a parchment-lined baking sheet. Preheat oven to 250°F.",
        "Melt cannabutter in saucepan, add brown sugar and corn syrup.",
        "Bring to a boil over medium heat — cook 5 minutes without stirring.",
        "Remove from heat, stir in baking soda and vanilla — it will foam.",
        "Pour caramel over popcorn and toss quickly to coat.",
        "Bake 1 hour, stirring every 15 minutes.",
        "Cool completely on parchment before breaking apart.",
      ],
    },
    {
      id: "buffalo-popcorn",
      ...
      units: ["g", "g", "ml", "g", "g"],
      instructions: [
        "Pop popcorn and transfer to a large bowl.",
        "Melt cannabutter in a small saucepan over low heat.",
        "Whisk hot sauce and garlic powder into the melted butter.",
        "Drizzle buffalo butter over popcorn while tossing continuously.",
        "Season with salt and toss until fully coated.",
        "Serve immediately.",
      ],
    },
    {
      ...
      instructions: [
        ...
        "Melt chocolate chips and cannabis coconut oil together — microwave in 30-second bursts, stirring between.",
        "Drizzle melted chocolate over popcorn in a thin stream.",
        "Sprinkle with flaky salt.",
        "Refrigerate 15-20 minutes until chocolate is fully set.",
