...
const standardRecipes: Record<string, any[]> = {
  ...
  "snacks": [
    ...
    },
    {
      ...
      servings: 24,
      ingredients: ["Flavored Jello Mix","Gelatin (unflavored)","Water","THC Tincture","Granulated Sugar"],
  ...
  "ice-cream": [
    ...
    },
    {
      ...
      servings: 6,
      ingredients: ["Heavy Cream","Whole Milk","Granulated Sugar","Cannabis Coconut Oil","Dark Chocolate Chips"],
      amounts: [480,240,150,30,100],
      units: ["ml","ml","g","ml","g"],
