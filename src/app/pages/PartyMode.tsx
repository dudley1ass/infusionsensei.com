...
const BUNDLES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chocolate Drizzle Popcorn", dose: "3–5mg per serving", tip: "Make it fancy. Melted dark chocolate + coconut oil.", link: "/popcorn", emoji: "🍫" },
    ],
  ...
  },
  {
    ...
    items: [
      { name: "Husky Northeast Maple Popcorn", dose: "2–3mg per handful", tip: "Melt butter + maple syrup, then fold in cannabutter and toss with popcorn.", link: "/popcorn", emoji: "🟦" },
      ...
      { name: "Great Lakes Caramel Apple Dip", dose: "1–3mg per dip serving", tip: "Stir infused caramel or cannabutter into dip and serve with apple slices.", link: "/spreads-dips", emoji: "🟨" },
    ],
