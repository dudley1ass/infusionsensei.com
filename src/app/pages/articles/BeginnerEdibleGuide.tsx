        ...
        <CardContent className="space-y-10">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {[
                ...
                { step:"4", title:"Dose carefully", color:"bg-purple-50 border-purple-200", content: <div className="space-y-2 text-sm text-gray-700"><p>Calculate THC per serving first using our calculator. Start with <strong>2.5–5mg</strong>. Wait <strong>2 full hours</strong> before deciding you need more. Take notes on what worked.</p><Link to="/thc-calculator" className="text-green-700 font-bold text-xs">Calculate My Dose →</Link></div> },
          ...
          <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link to="/thc-calculator"><button className="bg-green-600 hover:bg-green-700 text-white font-black px-6 py-3 rounded-xl transition-colors flex items-center gap-2">Calculate My Dose <ArrowRight className="w-4 h-4" /></button></Link>
