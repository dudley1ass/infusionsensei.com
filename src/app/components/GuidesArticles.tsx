...
import {
  ...
  Drumstick, PartyPopper, Flame, Users,
} from "lucide-react";
...
const CATEGORIES = [
  {
    ...
    color: "green",
    articles: [
      { title: "Best Edible Bases for Beginners (Butter, Oil, Tincture)", description: "Which carrier to start with for baking vs drinks — and how to use the builder with your real potency.", badge: "Start here", badgeColor: "bg-emerald-600", icon: Leaf, iconColor: "text-emerald-700", borderColor: "border-emerald-200", hoverBorder: "hover:border-emerald-400", path: "/learn/articles/best-edible-bases-beginners" },
      ...
      { title: "How to Dose Edibles Safely (Beginner Guide)", description: "The standard dose guide and how to calculate perfect portions every time.", badge: "Safety First", badgeColor: "bg-purple-600", icon: Calculator, iconColor: "text-purple-600", borderColor: "border-purple-200", hoverBorder: "hover:border-purple-400", path: "/learn/articles/how-to-dose-edibles-safely" },
      ...
      { title: "Cannabis Party Pack Planning (Food, Dose & Groceries)", description: "Pick a hero dish, set mg per guest, and use Party Mode so lists and splits stay organized.", badge: "Party Mode", badgeColor: "bg-violet-600", icon: PartyPopper, iconColor: "text-violet-600", borderColor: "border-violet-200", hoverBorder: "hover:border-violet-400", path: "/learn/articles/cannabis-party-pack-planning" },
      { title: "mg THC Per Serving for Party Edibles", description: "Social dose ranges, mixed crowds, and how to avoid accidental double dosing at the snack table.", badge: "Hosting", badgeColor: "bg-emerald-600", icon: Users, iconColor: "text-emerald-600", borderColor: "border-emerald-200", hoverBorder: "hover:border-emerald-400", path: "/learn/articles/mg-thc-per-serving-party-edibles" },
  ...
  },
  {
    ...
    color: "blue",
    articles: [
      { title: "How to Make Infused Peanut Butter (Easy Guide)", description: "Decarb, infuse oil, blend into PB, and calculate mg per tablespoon — the math most recipes skip.", badge: "Ready-to-eat base", badgeColor: "bg-amber-600", icon: Sandwich, iconColor: "text-amber-700", borderColor: "border-amber-200", hoverBorder: "hover:border-amber-400", path: "/learn/articles/infused-peanut-butter" },
      { title: "Infused Fudge Recipe (Easy, Portion-Friendly)", description: "A simple no-bake infused fudge method with clean square portions and quick mg-per-piece math.", badge: "Dessert", badgeColor: "bg-amber-700", icon: ChefHat, iconColor: "text-amber-700", borderColor: "border-amber-200", hoverBorder: "hover:border-amber-400", path: "/learn/articles/infused-fudge-recipe" },
      { title: "How to Infuse Cream Cheese (Easy Guide)", description: "Blend infused fat into cream cheese, nail mg per ounce, and use it in cheesecakes, dips, and frosting without guessing.", badge: "Ready-to-eat base", badgeColor: "bg-sky-600", icon: Milk, iconColor: "text-sky-700", borderColor: "border-sky-200", hoverBorder: "hover:border-sky-400", path: "/learn/articles/infused-cream-cheese" },
      { title: "How to Make Cannabutter (Easy Step-by-Step)", description: "The fast starter method: ratio, time, and dosing checks so your first batch is actually usable.", badge: "Start here", badgeColor: "bg-emerald-600", icon: ChefHat, iconColor: "text-emerald-700", borderColor: "border-emerald-200", hoverBorder: "hover:border-emerald-400", path: "/learn/articles/how-to-make-cannabutter" },
      { title: "THC Dosage Calculator Explained", description: "What each calculator input means and how to avoid hidden over-dosing mistakes.", badge: "Calculator", badgeColor: "bg-blue-600", icon: Calculator, iconColor: "text-blue-700", borderColor: "border-blue-200", hoverBorder: "hover:border-blue-400", path: "/learn/articles/thc-dosage-calculator-explained" },
      { title: "How to Use the THC Edibles Calculator (Step by Step)", description: "The input order we recommend so you never double-count flower or skip a dilution.", badge: "Walkthrough", badgeColor: "bg-sky-600", icon: Calculator, iconColor: "text-sky-700", borderColor: "border-sky-200", hoverBorder: "hover:border-sky-400", path: "/learn/articles/edibles-calculator-walkthrough" },
      { title: "Cannabis Wings Dosing: mg Per Wing", description: "Cook wings plain, sauce with cannabutter last, and portion guests safely.", badge: "Savory", badgeColor: "bg-orange-600", icon: Drumstick, iconColor: "text-orange-700", borderColor: "border-orange-200", hoverBorder: "hover:border-orange-400", path: "/learn/articles/cannabis-wings-dosing" },
      { title: "Wing Sauce THC Dosing (Butter & Heat)", description: "Butter swaps, off-heat finishing, and translating batch sauce into mg per wing.", badge: "Sauces", badgeColor: "bg-red-600", icon: Flame, iconColor: "text-red-600", borderColor: "border-red-200", hoverBorder: "hover:border-red-400", path: "/learn/articles/wing-sauce-thc-dosing" },
      { title: "How Strong Are Homemade Edibles?", description: "Real strength ranges and why homemade batches vary so much from person to person.", badge: "Potency", badgeColor: "bg-orange-600", icon: Zap, iconColor: "text-orange-700", borderColor: "border-orange-200", hoverBorder: "hover:border-orange-400", path: "/learn/articles/how-strong-are-homemade-edibles" },
      { title: "Weed Butter Ratio Guide", description: "Pick mild, medium, or strong cannabutter ratios before you infuse.", badge: "Reference", badgeColor: "bg-purple-600", icon: Beaker, iconColor: "text-purple-700", borderColor: "border-purple-200", hoverBorder: "hover:border-purple-400", path: "/learn/articles/weed-butter-ratio-guide" },
